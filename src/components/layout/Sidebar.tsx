...
export const Sidebar = ({ className, variant = 'overlay' }: SidebarProps) => {
  ...
  return (
    <div className={cn(
      "flex flex-col bg-white border-r border-neutral-200 shadow-xl h-full w-80",
      className
    )}>
      
      {/* Header do Sidebar - Reduzido */}
      <div className="p-6 border-b border-neutral-200 bg-gradient-to-br from-indigo-50 to-indigo-100">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="font-bold text-lg text-indigo-900">Flexi Gestor</h1>
      ...
      <nav className="flex-1 p-6 space-y-2">
        ...
        {navigationItems.map((item) => (
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                "group flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 min-h-[44px] relative overflow-hidden",
                isActive
      ...
      {/* Seção de Ferramentas - Compactada */}
      <div className="p-6 border-t border-neutral-200 bg-gradient-to-br from-neutral-50 to-neutral-100">
        <div className="mb-3">
      ...
      {/* Footer do Sidebar - Compactado */}
      <div className="p-4 border-t border-neutral-200 bg-gradient-to-br from-neutral-100 to-neutral-200">
        <div className="text-center">
          <p className="text-xs text-neutral-500 mb-1">Versão 2.0.0</p>
          <p className="text-xs text-neutral-400">© 2024 Flexi Gestor</p>
        </div>
      </div>
    </div>
  );
