...
export const StatsCard = ({ 
  ...
  return (
    <Card className={cn(
      "relative overflow-hidden bg-white border border-slate-200/50 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 rounded-xl",
      className
    )}>
      <CardContent className="p-6">
        <div className="flex items-center justify-between">
          ...
          {/* Ícone com Background Gradiente Suave */}
